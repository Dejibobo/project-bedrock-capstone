...
Cloud DevOps Engineer: Medayedu Ayodeji
...
S3 Bucket: bedrock-assets-Dejibobo-1163
...
S3 bucket: bedrock-tfstate-Dejibobo-1163
...
echo "test" > test.txt
aws s3 cp test.txt s3://bedrock-assets-Dejibobo-1163/test.txt
